...
if($ENV{VERSION_REL} STREQUAL "QNX_SDP700")
  message(STATUS "QNX VERSION_REL = " $ENV{VERSION_REL})
endif()
...
if($ENV{VERSION_REL} STREQUAL "QNX_SDP700")
  set(EXTRA_CMAKE_C_FLAGS "${EXTRA_CMAKE_C_FLAGS} -fpermissive")
  set(EXTRA_CMAKE_CXX_FLAGS "${EXTRA_CMAKE_CXX_FLAGS} -fpermissive")
  set(EXTRA_CMAKE_LINKER_FLAGS "${EXTRA_CMAKE_LINKER_FLAGS} -lc")
else()
